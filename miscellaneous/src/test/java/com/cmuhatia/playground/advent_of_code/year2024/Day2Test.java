...
class Day2Test {
    ...
    void countSafeReports() {
        assertEquals(2, Day2.countSafeReports(INPUT1));

        assertEquals(269, Day2.countSafeReports(LONG_INPUT));
    }

    @Test
    void countSafeReportsWithDampener() {
        assertEquals(4, Day2.countSafeReportsWithDampener(INPUT1));

        assertEquals(337, Day2.countSafeReportsWithDampener(LONG_INPUT));
    }

    @Test
    void countSafeReportsWithDampener2() {
        assertEquals(1, Day2.countSafeReportsWithDampener("3 3 4 5 7"));
        assertEquals(1, Day2.countSafeReportsWithDampener("13 3 4 5 7"));
    }
